...
class MeTL2011BackendAdaptor(name:String,hostname:String,meggleUrl:String) extends ServerConfiguration(name,hostname){
	...
	override def getMessageBusForRoom(id:String,room:MeTLRoom) = messageBusProvider.getMessageBusForRoom(id,room)
	override def releaseMessageBus(id:String) = messageBusProvider.releaseMessageBus(id)
	override def releaseMessageBusForRoom(id:String,room:MeTLRoom) = messageBusProvider.releaseMessageBusForRoom(id,room)
